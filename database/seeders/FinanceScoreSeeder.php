...
class FinanceScoreSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        'B3' => [
            1 => 'Tidak dilakukan climate scenario analysis portofolio.',
            2 => 'Analisis umum tanpa data kuantitatif.',
            3 => 'Model internal untuk sektor tertentu.',
            4 => 'Menggunakan NGFS/OJK CRMS/IWST pada portofolio utama.',
            5 => 'Diterapkan pada seluruh portofolio dan mengukur dampak NPL/CAR.'
        ],
        'B4' => [
            1 => 'Tidak ada kebijakan.',
            2 => 'Komitmen umum sustainable finance.',
            3 => 'Portofolio hijau/transisi <10%.',
            4 => 'Portofolio hijau/transisi 10-20% dan selaras TKBI.',
            5 => 'Portofolio >20%, kebijakan transition finance dan target dekarbonisasi portofolio.'
        ],
        'B5' => [
        ...
        'C1' => [
            1 => 'Tidak ada identifikasi risiko iklim dalam portofolio kredit.',
            2 => 'Identifikasi berdasarkan judgement umum sektor.',
            3 => 'Penilaian ESG/iklim parsial pada debitur tertentu.',
            4 => 'Climate credit risk assessment diterapkan pada sektor berisiko tinggi.',
            5 => 'Terintegrasi ke ERM, credit scoring, PD/LGD adjustment dan risk appetite bank.'
        ],
        'C2' => [
        ...
        'D3' => [
            1 => 'Tidak dihitung.',
            2 => 'Dihitung tanpa target pengurangan.',
            3 => 'Memiliki target internal per sektor.',
            4 => 'Menggunakan metodologi PCAF/SBTi-FI dan target transisi portofolio.',
            5 => 'Dilaporkan, diverifikasi dan digunakan dalam strategi dekarbonisasi pembiayaan.'
        ],
        'D4' => [
        ...
        'D6' => [
            1 => 'Tidak dilaporkan.',
            2 => 'Disclosure parsial sektor karbon tinggi.',
            3 => 'Memiliki batas risiko sektor karbon tinggi.',
            4 => 'Disclosure publik dan monitoring sektor prioritas.',
            5 => 'Konsisten dengan SASB/OJK dan memiliki strategi pengurangan exposure karbon intensif.'
        ],

        'E2' => [
            1 => 'Tidak ada program.',
            2 => 'Edukasi ESG umum.',
            3 => 'Pelatihan ESG/climate awareness tahunan.',
            4 => 'Pendampingan borrower untuk climate reporting/transition planning.',
            5 => 'Climate readiness borrower terintegrasi dalam kriteria kredit dan monitoring.'
        ],
        'E3' => [
