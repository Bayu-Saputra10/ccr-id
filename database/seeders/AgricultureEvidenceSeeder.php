...
class AgricultureEvidenceSeeder extends Seeder
{
    ...
    'B3' => [
        1 => ['id'=>'Data BMKG/IPCC','en'=>'BMKG/IPCC data'],
        2 => ['id'=>'Laporan agroclimate assessment','en'=>'Agroclimate assessment report'],
        3 => ['id'=>'Peta risiko lahan','en'=>'Land risk map'],
    ...
    'D2' => [
        ...
        2 => ['id'=>'Inventaris GRK','en'=>'GHG inventory'],
        3 => ['id'=>'Laporan operasional kebun','en'=>'Plantation operational report'],
        4 => ['id'=>'Lainnya','en'=>'Others'],
    ],
    ...
    'D5' => [
        1 => ['id'=>'Program irigasi','en'=>'Irrigation program'],
        2 => ['id'=>'Konservasi tanah','en'=>'Soil conservation'],
        3 => ['id'=>'Varietas tahan iklim','en'=>'Climate-resilient crop varieties'],
        4 => ['id'=>'Laporan agronomi','en'=>'Agronomy report'],
        5 => ['id'=>'Lainnya','en'=>'Others'],
    ],

        'E1' => [
        1 => ['id'=>'Data petani plasma','en'=>'Smallholder farmer data'],
        2 => ['id'=>'Audit pemasok','en'=>'Supplier audit'],
        3 => ['id'=>'Sertifikasi RSPO/ISPO','en'=>'RSPO/ISPO certification'],
        4 => ['id'=>'Lainnya','en'=>'Others'],
    ],

    'E2' => [
        1 => ['id'=>'Kontrak kemitraan','en'=>'Partnership agreement'],
        2 => ['id'=>'Program replanting','en'=>'Replanting program'],
        3 => ['id'=>'Laporan dampak sosial','en'=>'Social impact report'],
        4 => ['id'=>'Lainnya','en'=>'Others'],
    ],
