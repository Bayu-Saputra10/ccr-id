...
class FinanceSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        ['dimension'=>'B', 'indicator_id'=>'B3', 'indicator_name'=> 'Analisis skenario iklim portofolio', 'definiton'=>'Mengukur kemampuan lembaga keuangan melakukan stress testing dan analisis dampak iklim terhadap portofolio pembiayaan dan investasi.'],
        ['dimension'=>'B', 'indicator_id'=>'B4', 'indicator_name'=> 'Kebijakan pembiayaan hijau dan transisi', 'definiton'=>'Mengukur komitmen institusi keuangan dalam mengarahkan pembiayaan kepada aktivitas ekonomi rendah karbon dan berkelanjutan.'],
        ...
        // dimensi c
        ['dimension'=>'C', 'indicator_id'=>'C1', 'indicator_name'=> 'Identifikasi risiko fisik dan transisi  dalam portofolio kredit', 'definition'=>'Mengukur integrasi risiko fisik dan transisi ke dalam proses penilaian risiko kredit dan pengelolaan portofolio.'],
        ...
        ['dimension'=>'D', 'indicator_id'=>'D3', 'indicator_name'=> 'Target emisi portofolio (financed Emission)', 'definition'=>'Mengukur kemampuan institusi keuangan dalam menetapkan dan mengelola target pengurangan emisi yang berasal dari aktivitas pembiayaan.'],
        ...
        ['dimension'=>'D', 'indicator_id'=>'D6', 'indicator_name'=> 'Pelaporan exposure ke sektor karbon tinggi', 'definition'=>'Mengukur tingkat transparansi dan pengelolaan eksposur terhadap sektor ekonomi dengan intensitas karbon tinggi.'],

        // dimensi e
        ['dimension'=>'E', 'indicator_id'=>'E2', 'indicator_name'=> 'Peningkatan kapasitas borrower', 'definition'=>'Mengukur upaya lembaga keuangan dalam meningkatkan kesiapan debitur untuk mengelola risiko iklim dan transisi keberlanjutan.'],
