...
class ManufacturingScoreSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        'B4' => [
            ...
            2 => 'Hanya target internal.',
            3 => 'Target supplier utama.',
            4 => 'Diterapkan ke seluruh supplier besar.',
            5 => 'Supplier memiliki target SBTi/target emisi sendiri dan dimonitor.'
        ],
        'B5' => [
        ...
        'C5' => [
            1 => 'Tidak ada audit.',
            2 => 'Audit internal tanpa tindak lanjut.',
            3 => 'Audit tahunan dengan aksi korektif.',
            4 => 'Sertifikasi ISO 50001 atau sistem manajemen energi setara.',
            5 => 'Audit eksternal tahunan dan hasil dipublikasikan.'
        ],
        ...
        'D2' => [
            1 => 'Tidak dihitung.',
            2 => 'Diukur tetapi tidak dipantau.',
            3 => 'Tren efisiensi positif.',
            4 => 'Penurunan >3% per tahun.',
            5 => 'Penggunaan energi terbarukan >=25% atau efisiensi tervalidasi.'
        ],
        'D4' => [
        ...
        'D6' => [
            1 => 'Tidak diukur.',
            2 => 'Pengelolaan dasar.',
            3 => 'Sistem reuse/recycle 25% limbah/air.',
            4 => '>50% limbah/air didaur ulang/digunakan kembali.',
            5 => 'Sirkularitas penuh/zero waste dengan target dan verifikasi.'
        ],

        'E2' => [
            1 => 'Tidak ada pelibatan.',
            2 => 'Edukasi dasar kepada supplier.',
            3 => 'Supplier utama berkomitmen terhadap ESG.',
            4 => '75% supplier tersertifikasi/terverifikasi hijau.',
            5 => '100% supplier masuk ke sistem pengadaan hijau dan dimonitor.'
        ],
        'E3' => [
        ...
        'E4' => [
            1 => 'Hanya CSR umum tanpa fokus pada ketahanan iklim.',
            2 => 'Ada proyek adaptasi lokal kecil/ad hoc.',
            3 => 'Program multiyear untuk komunitas rentan.',
            4 => 'Dampak yang terukur pada air, bencana, kesehatan atau livelihood.',
        ...
        'E5' => [
            ...
            3 => 'Sistem formal tersedia dan dapat digunakan oleh pemangku kepentingan.',
