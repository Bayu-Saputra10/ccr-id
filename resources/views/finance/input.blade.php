...
@section('content')
<div class="px-3">
    <h3 class="fw-bold mb-4">Indikator Keuangan</h3>
    ...
    <form action="{{ route('finance.save', $assessment->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
                ...
                <tr>
                    ...
                    <td>
                        <select class="form-control" name="evidence[{{ $indicator->id }}]">
                            <option value="" selected disabled>Pilih Sumber Bukti
                            </option>
