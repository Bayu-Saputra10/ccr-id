...
class AgricultureController extends Controller
{
    public function index(Assessment $assessment) {
        $indicators = Agriculture::with(['scores', 'evidences'])->orderBy('dimension')->orderBy('indicator_id')->get();
        ...
        return view('agriculture.input', compact('assessment', 'indicators'));
    }
    ...
    public function save(Request $request, Assessment $assessment) {
        ...
        $indicators = Agriculture::orderBy('indicator_id')->get();
