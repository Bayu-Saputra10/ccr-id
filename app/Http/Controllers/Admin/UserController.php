...
class UserController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.users.index', compact('users', 'keyword', 'totalUser', 'totalAdmin', 'totalViewer'));
    ...
    public function update(Request $request, User $user)
    {
        ...
        if (
            $user->id === auth()->id() && $user->role === 'admin' && $request->role === 'viewer'
        ) {
            return back()->withInput()->with('error', 'Anda tidak dapat mengubah role akun Anda sendiri menjadi Viewer.');
        }
